...
public enum ATMToolMats implements ILWToolMats {
	ALLTHEMODIUM(new ModMats(() -> ATMTier.ALLTHEMODIUM, new ExtraToolConfig()), true, ModRegistry.ALLTHEMODIUM_INGOT, ModRegistry.ALLTHEMODIUM_BLOCK),
	VIBRANIUM(new ModMats(() -> ATMTier.VIBRANIUM, new ExtraToolConfig()), true, ModRegistry.VIBRANIUM_INGOT, ModRegistry.VIBRANIUM_BLOCK),
	UNOBTAINIUM(new ModMats(() -> ATMTier.UNOBTAINIUM, new ExtraToolConfig()), true, ModRegistry.UNOBTAINIUM_INGOT, ModRegistry.UNOBTAINIUM_BLOCK),
	;
