...
public class TagGen {
	...
	public static void onItemTagGen(RegistrateTagsProvider<Item> pvd) {
		...
		pvd.addTag(ItemTags.WEAPON_ENCHANTABLE).addTags(
		...
		pvd.addTag(ItemTags.SWORD_ENCHANTABLE).addTags(
				DAGGER, SPEAR, NUNCHAKU, HAMMER, BATTLE_AXE, CLAW, MACHETE, JAVELIN, THROWING_AXE
		);
		pvd.addTag(Tags.Items.ENCHANTABLES).addTags(
				DOUBLE_WIELD, THROWABLE, SHIELDS, HEAVY
		);
		...
		pvd.addTag(Tags.Items.MELEE_WEAPON_TOOLS).addTags(
				DAGGER, SPEAR, NUNCHAKU, HAMMER, BATTLE_AXE, CLAW, MACHETE, JAVELIN, THROWING_AXE, PLATE_SHIELD
		);
		pvd.addTag(Tags.Items.MINING_TOOL_TOOLS).addTags(
				DAGGER, SPEAR, NUNCHAKU, HAMMER, BATTLE_AXE, CLAW, MACHETE, JAVELIN, THROWING_AXE
		);
