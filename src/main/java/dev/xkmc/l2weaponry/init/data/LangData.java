...
public enum LangData {
	...
	TOOL_PLATE_SHIELD("tool.plate_shield", "Resistant against attacks that would break regular shields. Reflect damage with right timing. Knockback enemies on hit, and deal 3x damage on critical hit.", 0),
